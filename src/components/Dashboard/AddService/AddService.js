...
const AddService = () => {
    ...
    const onSubmit = (data) => {
        ...
        fetch("https://floating-coast-84242.herokuapp.com/addService", {
            method: "POST",
            headers: {
        ...
        <div>
            ...
            <form className="p-3" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-group m-1">
                            ...
                            <input type="file" onChange={handleImageUpload} id="packageImage" required name="packageImage" placeholder="Package Image" className="form-control" />
